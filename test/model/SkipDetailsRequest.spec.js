...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AdyenHppJs.SkipDetailsRequest();
  });
  ...
  describe('SkipDetailsRequest', function() {
    it('should create an instance of SkipDetailsRequest', function() {
      // uncomment below and update the code to test SkipDetailsRequest
      //var instane = new AdyenHppJs.SkipDetailsRequest();
      //expect(instance).to.be.a(AdyenHppJs.SkipDetailsRequest);
    });
