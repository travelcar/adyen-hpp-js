...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AdyenHppJs.PaymentRequest = factory(root.AdyenHppJs.ApiClient, root.AdyenHppJs.RecurringContractType);
  }
  ...
  /**
   * Returns A shopper's telephone number.
   * @return {String}
   */
  ...
  /**
   * Sets A shopper's telephone number.
   * @param {String} telephoneNumber A shopper's telephone number.
   */
